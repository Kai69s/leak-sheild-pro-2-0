...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    body::before {
      content: "Made By Mustafa Ahmed";
      position: fixed;
      top: 47%;
      left: 50%;
      z-index: 0;
      transform: translate(-50%, -50%) rotate(-32deg);
      color: rgba(24, 68, 115, 0.075);
      font-size: 56px;
      font-weight: 800;
    ...
    .cover {
      ...
      color: white;
      background:
        linear-gradient(135deg, rgba(7, 18, 39, 0.96), rgba(17, 42, 71, 0.92)),
        radial-gradient(circle at 80% 20%, rgba(103, 232, 249, 0.34), transparent 30%);
      border-radius: 8px;
      overflow: hidden;
    }
    .cover h1 {
    ...
    .cover .tag {
      ...
      border: 1px solid rgba(157, 231, 244, 0.65);
      padding: 8px 12px;
      color: #cffafe;
      font-size: 12px;
      font-weight: 700;
...
<body>
  <section class="page cover">
    ...
    <div class="author">Made By Mustafa Ahmed</div>
  </section>
  ...
  <section class="page">
    ...
    <p class="small">Watermark: Made By Mustafa Ahmed</p>
  </section>
</body>
</html>`;
